...
function OpportunitiesImageFallback() {
  return (
    <div className="relative flex aspect-[16/10] w-full items-center justify-center bg-gradient-to-br from-primary/90 via-primary/70 to-primary-light/60">
      ...
      <svg width="48" height="48" viewBox="0 0 64 64" fill="none" className="relative z-10 text-white/25">
        ...
        <path d="M8 44l12-10 8 6 16-14 12 10" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
      </svg>
    </div>
  );
}
    ...
    <section id="features" className="px-6 py-16 md:py-24">
      <div className="mx-auto max-w-7xl">
        <div className="relative overflow-hidden rounded-2xl shadow-lg">
          <SiteImage
            src={siteImages.home.opportunities}
            alt="Proactive relationship opportunities"
            className="relative aspect-[16/10] w-full overflow-hidden"
            fallback={<OpportunitiesImageFallback />}
          ...
          <div className="flex items-start gap-4">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-tertiary/50">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-secondary">
                <rect x="3" y="8" width="18" height="14" rx="2" fill="currentColor" opacity="0.2" />
                <path d="M12 8V3M12 3C12 3 9 3 8 5s1 3 4 3M12 3c0 0 3 0 4 2s-1 3-4 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
