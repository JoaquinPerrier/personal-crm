...
function DeepDetailsImageFallback() {
  return (
    <div className="relative flex h-28 w-full items-center justify-center bg-gradient-to-br from-secondary/30 to-tertiary/50">
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" className="text-secondary/50">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid grid-cols-2 gap-4 md:grid-cols-4 md:gap-6">
          <div className="rounded-2xl bg-surface p-6 shadow-sm">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-primary/10">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="text-primary">
                <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Z" fill="currentColor" opacity="0.15" />
          ...
          <div className="overflow-hidden rounded-2xl bg-surface shadow-sm">
            <SiteImage
              src={siteImages.home.atriumDeepDetails}
              alt="Deep contact details"
              className="relative h-28 w-full overflow-hidden"
              fallback={<DeepDetailsImageFallback />}
